...
[Code of Conduct]: https://significant-gravitas.github.io/Objectivize/code-of-conduct.md

## 📢 A Quick Word

Right now we will not be accepting any Contributions that add non-essential commands to Objectivize.

However, you absolutely can still add these commands to Objectivize in the form of plugins.
...
https://github.com/Significant-Gravitas/Objectivize/pulls?q=is%3Apr+is%3Aopen+-label%3Aconflicts
...
For more info on running tests, please refer to ["Running tests"](https://significant-gravitas.github.io/Objectivize/testing/).
...
- If the prompt changes in a way that the cassettes are not reusable:
  ...
  - If the API key is present, the tests will make a real call to OpenAI.
    ...
    - If the test is unsuccessful:
      - Either: Your change made Objectivize less capable, in that case, you have to change your code.
