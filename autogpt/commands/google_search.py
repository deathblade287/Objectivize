...
def google_official_search(query: str, num_results: int = 8) -> str | list[str]:
    ...
    try:
        ...
        # Filtering the results (only whitelisted sites allowed) => objective facts

        whitelistedURLS = ["https://www.wikipedia.org/"]

        for i in range(len(search_results_links)):
            link = search_results_links[i]
