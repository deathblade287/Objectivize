...
def prompt_user() -> AIConfig:
    ...
    user_desire = utils.clean_input(
        f"{Fore.LIGHTBLUE_EX}I want Objectivize to{Style.RESET_ALL}: "
    )

    if user_desire == "":
        user_desire = "Write a wikipedia style article about the project: https://github.com/significant-gravitas/Objectivize"  # Default prompt
