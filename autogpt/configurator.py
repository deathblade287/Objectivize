...
def create_config(
    ...
    Args:
        ...
        allow_downloads (bool): Whether to allow Objectivize to download files natively
    ...
    if allow_downloads:
        ...
        logger.typewriter_log(
            "WARNING: ",
            Fore.YELLOW,
            f"{Back.LIGHTYELLOW_EX}Objectivize will now be able to download and save files to your machine.{Back.RESET} "
